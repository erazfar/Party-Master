...
public class bufImageArrBackUp extends ElementAnimation {

    private BufferedImage favicon;
    private File file;
    BufferedImage [] images;

    public bufImageArrBackUp(LightMaster master, int startTime, String internalID,
    ...
    private void downloadFavicon() 
    {
        ...
        File folder = new File("Party Rock Icons");
